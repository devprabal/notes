...
.PHONY: clean
clean:
	@echo "$(COLOR_YELLOW)Deleting$(COLOR_NONE) pre-existing (if any) files $(COLOR_BLUE)$(OBJS)$(COLOR_NONE)"
	@rm -f $(OBJS)
...
.PHONY: script
script:
	@echo "$(COLOR_YELLOW)Generating$(COLOR_NONE) script file $(COLOR_BLUE)build.sh$(COLOR_NONE)"
...
.PHONY: README
README:
	@echo "$(COLOR_YELLOW)Generating$(COLOR_NONE) README file $(COLOR_BLUE)README.md$(COLOR_NONE)"
...
index.html: README.md style.css
	...
	@rm -f $@.temp
	@echo "generated $(COLOR_BLUE)index.html$(COLOR_NONE)"
